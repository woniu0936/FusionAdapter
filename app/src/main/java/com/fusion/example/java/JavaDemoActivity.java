package com.fusion.example.java;

import static android.view.View.GONE;
import static com.fusion.example.kotlin.ExtensionsKt.fullStatusBar;
...
import com.fusion.example.java.delegate.JavaMsgTextDelegate;
import com.fusion.example.java.delegate.JavaTextDelegate;
...
public class JavaDemoActivity extends AppCompatActivity {
    ...
    private void loadData() {
        ...
        List<FusionMessage> chatList = MockDataGenerator.INSTANCE.createChatList(10, 0);
